        ...
        Column(
            ...
            Box(
                ...
                HideableSearchTextField(
                    ...
                    isSearchActive = state.value.isSearchFieldActive,
                    onTextChange = viewModel::onSeachTextChange,
               ...
               this@Column.AnimatedVisibility(
                    visible = !state.value.isSearchFieldActive,
                    enter = fadeIn(),
                    exit = fadeOut()
                ) {
                    Text(
            ...
            LazyColumn(
              ...
              items(
                  ...
                  NoteItem(
                      ...
                      onDeleteClicked = {
                          viewModel.onDeleteNoteById(note.id!!)
                      },
                      modifier = Modifier
                          .fillMaxWidth()
                          .padding(16.dp)
